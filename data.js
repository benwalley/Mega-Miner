function initGlobalVariables() {
    window.gameData = {
        ...
        blockTypeMap: {
            ...
            stone: {probability: 150, color: '#555555', hardness: 1000, value: 0, first: 1, gasUsed: 5},
            coal: {probability: 20, color: '#222222', hardness: 1500, value: 25, first: 5, gasUsed: 7},
            iron: {probability: 10, color: '#8f9399', hardness: 2500, value: 50, first: 30, gasUsed: 15},
            silver: {probability: 8, color: '#e2e2e2', hardness: 3000, value: 100, first: 50, gasUsed: 20},
            gold: {probability: 5, color: '#ed8f1c', hardness: 3500, value: 200, first: 80, gasUsed: 25},
            sapphire: {probability: 4, color: '#1875ff', hardness: 4000, value: 300, first: 120, gasUsed: 30},
            emerald: {probability: 4, color: '#1d8600', hardness: 4500, value: 450, first: 200, gasUsed: 35},
            ruby: {probability: 2, color: '#a90e0e', hardness: 5000, value: 600, first: 300, gasUsed: 45},
            diamond: {probability: 1, color: '#6ddef3', hardness: 6000, value: 1000, first: 400, gasUsed: 50},
